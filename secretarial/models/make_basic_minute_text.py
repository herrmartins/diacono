...
def make_minute(name_dict):
    text = [
        ...
        " sob a liderança do ",
        "presidente",
        ". Ele orou e declarou aberta a sessão. <p>O(a) secretário(a) ",
        "secretary",
        " leu a ata da reunião anterior. O(a) irmão(ã)",
        "minute_reading_acceptance_proposal",
        " propôs a aceitação da ata lida e o(a) irmão(ã)",
        ...
        " propôs a aceitação do relatório financeiro, recendo apoio do(a) irmão(ã)",
