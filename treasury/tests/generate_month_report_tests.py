...
class GenerateMonthlyReportViewTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        mommy.make(MonthlyBalance, month=cls.date_before, balance=100)
    ...
    def test_monthly_balance_calculation(self):
        ...
        mommy.make(MonthlyBalance, month=previous_month, balance=100)
        ...
        mommy.make(TransactionModel, date=main_date, amount=-20)
        ...
        mommy.make(TransactionModel, date=next_month, amount=-30)
        mommy.make(TransactionModel, date=next_month, amount=70)
